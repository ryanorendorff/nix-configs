{ stdenv, buildPythonPackage, isPyPy, fetchpypi, pytest, pytestcov, pytest-mock, freezegun, jinja2, future, binaryornot, click, whichcraft, poyo, jinja2_time, requests }:
